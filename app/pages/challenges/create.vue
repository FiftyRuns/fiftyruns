        ...
        <section class="rounded-3xl border border-black/5 bg-white/90 p-8 shadow-sm backdrop-blur">
          ...
          <div class="mt-6 space-y-5">
            <div class="grid gap-5 sm:grid-cols-2">
              ...
              <label class="flex flex-col gap-2 text-sm font-medium text-gray-700">
                Zeitraum Start
                <input v-model="form.startAt" type="date" lang="de" required class="rounded-xl border border-gray-300 px-3 py-2 text-sm text-gray-800 shadow-sm focus:border-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20" />
              </label>
              <label class="flex flex-col gap-2 text-sm font-medium text-gray-700">
                Zeitraum Ende
                <input v-model="form.endAt" type="date" lang="de" required class="rounded-xl border border-gray-300 px-3 py-2 text-sm text-gray-800 shadow-sm focus:border-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20" />
              </label>
              <label class="flex flex-col gap-2 text-sm font-medium text-gray-700">
                Sichtbarkeit
